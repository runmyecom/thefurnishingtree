<div>
    <a
        class="flex flex-col group bg-white rounded-xl transition dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]"
        {{-- href="{{ route('item-by-model', $item->model_id) }}" --}}
    >
