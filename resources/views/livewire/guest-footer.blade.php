<footer class="relative z-10 bg-white dark:bg-dark pt-20 pb-10 border-t">
        ...
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                ...
                <a
                    ...
                    class="mb-6 inline-block max-w-[100px]"
                    >
                    <img
                        src="/images/tft.png"
                        alt="logo"
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a
                            href="{{ route('cancellation-refund') }}"
                            class="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6"
                            >
