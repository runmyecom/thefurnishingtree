<div class="h-full">
    <div class="w-full h-full overflow-x-hidden overflow-y-auto">
        <div class="w-full flex flex-col items-center h-full">
            <form wire:submit="import" class="w-full flex flex-col h-full bg-white border justify-between shadow-sm rounded-xl">
                <div class="flex justify-between items-center py-3 px-4 border-b">
                    <h3 class="font-bold text-gray-800">Delete Category List</h3>
                </div>
