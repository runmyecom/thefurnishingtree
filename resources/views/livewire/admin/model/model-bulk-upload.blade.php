        ...
        <div class="w-full flex items-center">
            <form wire:submit="import" class="w-full flex flex-col bg-white border shadow-sm rounded-xl">
                <div class="flex justify-between items-center py-3 px-4 border-b">
                    <h3 class="font-bold text-gray-800">Import Item Model List</h3>
                </div>
                <div class="px-20 py-6 overflow-y-auto">
                    <p class="text-gray-500">Through imports you can add or update item model. To update existing item model you must set an existing id in the Category id columns. If the value is unset a new record will be created. You will be asked for confirmation before we import category.</p>
