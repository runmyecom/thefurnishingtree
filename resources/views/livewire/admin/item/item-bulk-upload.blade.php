<div>
    <div class="w-full h-full overflow-x-hidden overflow-y-auto rounded-xl">
        <div class="w-full flex flex-col items-center">
            ...
            <section class="w-full py-6 px-20">
                <p class="font-bold">Unsure about how to arrange your list?</p>
                <p class="text-sm text-gray-500">Download the template below to ensure you are following the correct format.</p>
                <!-- Sample -->
                <div class="border-2 border-dashed rounded-xl flex items-center justify-between p-4 my-6">
                    <div class="flex gap-2 items-center">
                        ...
                        <div >
                            <h3 class="text-sm">Download Sample Sheet</h3>
                            <p class="text-xs text-gray-500">Only .xlxs files are supported.</p>
                        </div>
                    </div>
                    <a href="/exports/items-sample.xlsx">
