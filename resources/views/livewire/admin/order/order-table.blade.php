      ...
      <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          @isset($data)
              ...
              <tr>
                  ...
                  <td class="h-px w-px whitespace-nowrap">
                      <div class="px-6 py-3">
                          <span class="text-sm text-gray-600 dark:text-gray-400">{{ $order->tracking_no }}</span>
                      </div>
                  </td>
                  <td class="h-px w-px whitespace-nowrap">
                      <div class="px-6 py-3">
                          <span class="text-sm text-gray-600 dark:text-gray-400">{{ $order->fullname }}</span>
                      </div>
                  </div>
                  </td>
                  <td class="h-px w-px whitespace-nowrap">
                  <div class="px-6 py-3">
                      <span class="text-sm text-gray-600 dark:text-gray-400">{{ $order->created_at }}</span>
                  </div>
                  </td>
                  <td class="h-px w-px whitespace-nowrap">
