            ...
            <div class="inline-flex gap-x-2">
                ...
                <div class="flex justify-center">
                    ...
                    >
                        ...
                        >
                            <a href="/category/bulk-upload" class="flex items-center gap-2 w-full first-of-type:rounded-t-md last-of-type:rounded-b-md px-4 py-2.5 text-left text-sm hover:bg-gray-50 disabled:text-gray-500">
                                <x-icons.upload class="w-5 h-5 text-gray-700" />
                                <span class="text-sm">Bulk Upload</span>
                            </a>

                            <a href="/category/bulk-update" class="border-t flex items-center gap-2 w-full first-of-type:rounded-t-md last-of-type:rounded-b-md px-4 py-2.5 text-left text-sm hover:bg-gray-50 disabled:text-gray-500">
                                <x-icons.update class="w-5 h-5 text-gray-700" />
                                <span class="text-sm">Update Sheet</span>
                            </a>

                            <a href="/category/bulk-delete" class="border-t flex items-center gap-2 w-full first-of-type:rounded-t-md last-of-type:rounded-b-md px-4 py-2.5 text-left text-sm hover:bg-gray-50 disabled:text-gray-500">
                ...
                <livewire:admin.category.category-export />
